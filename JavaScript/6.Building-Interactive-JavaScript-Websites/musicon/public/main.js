const context = {
  ...
  instruments: [
    ...
    {
      image: 'https://images.unsplash.com/photo-1598367772323-3ae346826817?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80',
      name: 'Saxonphone',
      description: 'Ever thought, "I want to play most sexiest instrument in the world"? Find an answer in the Saxophone. Whenever you play this in front of the people, 100% you will get attracted by a lots of people around you.',
      price: '$2,199.00',
      sale: 'On Sale!',
      deal: '$1,749.00'
    }
